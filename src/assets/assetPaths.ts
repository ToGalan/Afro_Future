...
export const FactionIcon: Record<string, string> = {
...
export const CharacterPortrait: Record<'MALE' | 'FEMALE', string> = {
  MALE: '/assets/characters/male_default.svg',
  FEMALE: '/assets/characters/female_default.svg',
};

export const PetIcon: Record<string, string> = {
...
export type ImageAssetsType = typeof ImageAssets;

export function getCharacterPortrait(faction: keyof typeof ImageAssets.characters, archetype: 'MALE' | 'FEMALE'): string {
