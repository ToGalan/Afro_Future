...
export async function loadSnapshot(world, idToken) {
    try {
...
export async function saveSnapshot(world, update, idToken, alreadyGzip = false) {
    try {
...
export function joinRoom(roomId, handlers = {}, idToken) {
...
export function setStoredIdToken(token) {
    if (token)
