...
function LeftPlayerPanel({ className = '', playerName, accountLevel, loadout, onCustomize, heroLocked }) {
    return (_jsxs("aside", { className: `col-start-1 h-full ${className} bg-[#0f1218] border-r border-black/40 shadow-inner flex flex-col`, children: [_jsxs("div", { className: "px-4 py-4 border-b border-white/10 flex flex-col items-center", children: [_jsxs("div", { className: "w-[240px] h-[260px] rounded-3xl border border-white/10 bg-[#12171f] overflow-hidden relative flex flex-col items-stretch", children: [_jsxs("div", { className: "absolute inset-0", children: [_jsx(AvatarScene, { parts: loadout.threeConfig?.parts, colors: loadout.threeConfig?.colors, debugTint: false, animPaused: false, animSpeed: 1, rotateSpeed: 0.08, disableControls: true, cameraPosition: [1.65, 1.4, 2.15], cameraFov: 33, target: [0, 1.05, 0], autoFrame: true, frameMargin: 0.14 }), _jsx("div", { className: "absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#0b0e13] to-transparent" })] }), _jsx("img", { className: "absolute top-2 right-2 w-16 h-16 object-cover rounded-xl border border-white/10 shadow-lg opacity-80", src: loadout.portraitUrl, alt: "portrait" }), _jsxs("div", { className: "relative z-10 px-3 pb-3 pt-2 flex flex-col items-center text-center mt-auto", children: [_jsxs("div", { className: "flex items-center gap-2 mb-1", children: [_jsx("img", { src: FactionIcon[loadout.faction], alt: loadout.faction, className: "w-5 h-5 drop-shadow" }), _jsx("span", { className: "font-semibold text-white text-sm leading-tight tracking-wide", children: loadout.name })] }), _jsxs("div", { className: "text-[10px] text-gray-300 flex items-center gap-2", children: [_jsxs("span", { className: "px-2 py-0.5 rounded-full bg-white/5 border border-white/10 tracking-wide", children: ["Lv ", loadout.level] }), _jsx("span", { children: loadout.archetype === 'MALE' ? 'Male' : 'Female' })] })] }), _jsxs("span", { className: "absolute top-2 left-2 px-2 py-1 rounded-lg bg-black/50 border border-white/10 text-[10px] tracking-wide flex items-center gap-1", children: [_jsx("img", { src: FactionIcon[loadout.faction], alt: "faction", className: "w-3.5 h-3.5" }), loadout.faction] })] }), _jsx("div", { className: "mt-4 grid grid-cols-3 gap-3 w-full", children: [
                            { label: 'Attack', value: '●●●○○' },
                            { label: 'Defense', value: '●●○○○' },
                            { label: 'Utility', value: '●●●●○' },
